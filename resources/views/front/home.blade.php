                    ...
                    @foreach ($posts as $post)
                        <div class="col-lg-4 col-md-4">
                            <div class="fh5co-blog animate-box">
                                <a href="{{ 'article', $post->uri }}"><img class="img-responsive" src="{{ Storage::url(\App\Support\Cropper::thumb($post->cover, 800, 450)) }}" alt=""></a>
                                <div class="blog-text">
                                    <h3><a href="{{ 'article', $post->uri }}">{{ $post->title }}</a></h3>
                                    ...
                                    <p>{{ $post->subtitle }}</p>
                                    <a href="{{ 'article', $post->uri }}" class="btn btn-primary">Leia mais</a>
                                </div>
                            </div>
                        </div>
